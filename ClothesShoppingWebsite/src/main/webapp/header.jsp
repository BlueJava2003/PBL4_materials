		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form action="search" method="get" class="d-flex" role="search">
					<input name="search" value="${searchName}" class="form-control me-2" type="text" placeholder="Search" aria-label="Search">
							...
							<li class="nav-item dropdown dropstart"><a
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item"
										href="<%=url%>/CustomerJsp/thaydoianh.jsp">Thay đổi
											ảnh đại diện</a></li>
									<li><a class="dropdown-item"
										href="<%=url%>/CustomerJsp/thaydoithongtin.jsp">Thay đổi
											thông tin</a></li>
									<li><a class="dropdown-item"
										href="<%=url%>/CustomerJsp/doimatkhau.jsp">Đổi mật khẩu</a></li>
									<li><hr class="dropdown-divider"></li>
									<li><a class="dropdown-item"
