...
/**
 * Servlet implementation class KhanhHangThayDoiAnh
 */
@WebServlet("/khanh-hang-thay-doi-anh")
public class KhanhHangThayDoiAnh extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public KhanhHangThayDoiAnh() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String hd = request.getParameter("hanhDong");
		...
		if (khachHang != null) {
			try {
				String folder = getServletContext().getRealPath("avatar"); //Do đường dẫn chỗ này!
